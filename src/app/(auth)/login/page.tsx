  ...
  return (
    <div className="w-full max-w-sm">
      ...
      <div className="text-center mb-8">
        ...
        <h1 className="text-2xl font-bold text-[#e8f4ff]" style={{ fontFamily: 'var(--font-sora)' }}>Welcome back</h1>
        <p className="text-sm text-[#6a9ab8] mt-1">Sign in to your Nexus island</p>
      </div>
      ...
      <div className="glass-card p-6">
        ...
        <form onSubmit={handleLogin} className="flex flex-col gap-3">
          ...
          <div>
            ...
            <input className="island-input" type="password" placeholder="••••••••"
      ...
      <p className="text-center text-xs text-[#3a6080] mt-4">
        ...
        <Link href="/signup" className="text-[#5bc4f5] hover:underline">Create one free</Link>
      </p>
    </div>
  )
}
